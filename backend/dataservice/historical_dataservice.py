...
from backend.models.candleStick import CandleStickListDataType, ContractTypeEnum, ExpiryTypeEnum
...
class HistoricalDataService:
    ...
    def getOptionsData(self, ticker: str, strike: int, expiry_type: ExpiryTypeEnum, contract_type: ContractTypeEnum, datetime: datetime):
